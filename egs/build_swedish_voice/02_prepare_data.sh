...
PrintUsageThree () {
echo ""
echo "Please place your hts label files in ${lab_dir}"
}
...
./../../misc/scripts/vocoder/world/extract_features_for_merlin.sh database/wav/ $voice_dir/acoustic_model/data/
