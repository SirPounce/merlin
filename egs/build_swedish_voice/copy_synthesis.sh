...
work_dir="/data/joniva/build_swedish_voice"


# tools directory
#HB recompiled with f0_floor = 51
world="${merlin_dir}/tools/bin/WORLD"
#world="${merlin_dir}/tools/bin/WORLD_v2"
sptk="${merlin_dir}/tools/bin/SPTK-3.9"

# input audio directory
#wav_dir="${merlin_dir}/tools/WORLD/wav_test"
#wav_dir="${work_dir}/egs/build_your_own_voice/s1/copy_synthesis_in"
wav_dir="${work_dir}/copy_synthesis_in"

# Output features directory
#out_dir="${merlin_dir}/tools/WORLD/wav_test"
#out_dir="${work_dir}/egs/build_your_own_voice/s1/copy_synthesis_out"
out_dir="${work_dir}/copy_synthesis_out"
